...
As described in Section \ref{sec:software_description}, test spectra are denoised by transforming the scores back into spectral space (by multiplication with the loadings matrix). The resulting spectra are significantly smoother and easier to interpret, as can be seen in Figure %\ref{fig:denoised_spectrum}.
TO DO

\begin{comment}
\begin{figure}
\includegraphics[width=\textwidth]{denoised_spectrum.png}
\caption{...}
